...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(@NonNull Context context, @Nullable AttributeSet attrs,
        ...
        mOrderingAsAdded =
                a.getBoolean(R.styleable.PreferenceGroup_orderingFromXml, true);

        if (a.hasValue(R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            setInitialExpandedChildrenCount(a.getInt(R.styleable.PreferenceGroup_initialExpandedChildrenCount, Integer.MAX_VALUE));
        }
        a.recycle();
    }
