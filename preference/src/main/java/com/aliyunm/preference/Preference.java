...
public class Preference implements Comparable<Preference> {
    ...
    private PreferenceType mPreferenceType = PreferenceType.NORMAL;
     ...
     * {@link androidx.preference.CheckBoxPreference} constructor calls this version of the super class constructor
     ...
     * attributes as well as the {@link androidx.preference.CheckBoxPreference} class's attributes.
     *
    ...
    public Preference(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr,
        ...
        mTitle = a.getText(R.styleable.Preference_title);

        mSummary = a.getText(R.styleable.Preference_summary);

        mOrder = a.getInt(R.styleable.Preference_order, DEFAULT_ORDER);

        mFragment = a.getString(R.styleable.Preference_fragment);

        mLayoutResId = a.getResourceId(R.styleable.Preference_layout, R.layout.preference);

        mWidgetLayoutResId = a.getResourceId(R.styleable.Preference_widgetLayout, 0);

        mEnabled = a.getBoolean(R.styleable.Preference_enabled, true);

        mSelectable = a.getBoolean(R.styleable.Preference_selectable, true);

        mPersistent = a.getBoolean(R.styleable.Preference_persistent, true);
        ...
        mShouldDisableView =
                a.getBoolean(R.styleable.Preference_shouldDisableView, true);
        ...
        mIconSpaceReserved = a.getBoolean(R.styleable.Preference_iconSpaceReserved, false);

        mVisible = a.getBoolean(R.styleable.Preference_isPreferenceVisible, true);

        mCopyingEnabled = a.getBoolean(R.styleable.Preference_enableCopying, false);
    ...
    private void setBackground(View itemView) {
        ...
        switch (getPreferenceType()) {
            case HEADER: {
                resId = R.drawable.bg_setting_item_header;
                break;
            }
            case NORMAL: {
                resId = R.drawable.bg_setting_item_normal;
                break;
            }
            case FOOTER: {
                resId = R.drawable.bg_setting_item_footer;
     ...
     * 获取首选项类型
     *
     * @param mPreferenceType
     */
    public void setPreferenceType(PreferenceType mPreferenceType) {
        this.mPreferenceType = mPreferenceType;
    }
     ...
     * preference.
     *
     * <p> Simple implementations are provided for {@link androidx.preference.EditTextPreference} and
     * {@link androidx.preference.ListPreference}. To enable these implementations, use
